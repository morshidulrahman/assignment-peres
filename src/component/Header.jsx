...
export default function Header() {
  return (
    <div className="bg-[#F0F1EE] w-full">
      <div className="grid grid-cols-1 px-4 md:grid-cols-2 gap-12 items-center container mx-auto">
        <div>
          ...
          <h1 className="text-[48px] font-bold leading-[56px]">#1 Platform Powering Health and Wellness</h1>
          <p className="text-[24px] font-medium leading-[32px] mt-10">We are restoring home as the primary place of personal well-being</p>
        ...
        >
          <div className="bg-[#ffffffb3] w-full rounded-[17px] backdrop-blur-[12px]">
            ...
            <div className="flex items-center py-6 px-8 bg-[#ffffff99] backdrop-blur-[12px] rounded-[17px] gap-[34px]">
              <p className="text-[16px] font-medium leading-6">Find your wellbeing</p>
